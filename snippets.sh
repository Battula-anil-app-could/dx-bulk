...
upgrade_devnet() {
    ...
    --gas-limit=40000000 \
    --send \
    --proxy="https://devnet-gateway.dharitri.com" --chain=D || return
}
upgrade_testnet() {
    ...
    --gas-limit=40000000 \
    --send \
    --proxy="https://testnet-gateway.dharitri.com" --chain=T || return
}
...
upgrade_mainnet_all() {
    ...
    --gas-limit=40000000 \
    --send \
    --proxy="https://gateway.dharitri.com" --chain=1 
    ...
    --gas-limit=40000000 \
    --send \
    --proxy="https://gateway.dharitri.com" --chain=1 || return
}

verify_mainnet_all() {
    mxpy --verbose contract verify "erd1qqqqqqqqqqqqqpgqtnksqd6rs4a74mf4un5h2w2tt5lanfmaayxqs35jth" \
    --packaged-src=./output/xbulk/xbulk-2.0.0.source.json --verifier-url="https://play-api.dharitri.com" \
    --docker-image="dharitri/sdk-rust-contract-builder:v5.0.0" \
    --ledger --ledger-address-index 3
